eventCompileStart = { kind ->
	...
	if (!angularScaffoldingConfigFile.exists()){
		...
		event("StatusUpdate", ["copying AngularScaffoldingConfig.groovy"]) //println ('* copying SecurityConfig.groovy')
	...
	event("StatusUpdate", ["Adding $newConfigFiles configuration files to grails.config.locations"]) //println ('* Adding angular-scaffolding configuration files to grails.config.locations');
